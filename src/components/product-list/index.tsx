        ...
        {products &&
          products.map((product) => {
            ...
            const price = 
              ...
              product.masterData.current.masterVariant.prices[0].value.centAmount || 0) / 100;
            const finalPrice = (product.masterData.current.masterVariant.prices &&
              product.masterData.current.masterVariant.prices[0].discounted?.value.centAmount || 0) / 100;
